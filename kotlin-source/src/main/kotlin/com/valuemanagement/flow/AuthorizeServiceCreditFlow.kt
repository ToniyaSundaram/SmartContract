...
import com.valuemanagement.flow.AuthorizeServiceCreditFlow.Acceptor
...
object AuthorizeServiceCreditFlow {
    @InitiatingFlow
    @StartableByRPC
    class Authorizer(val serviceCreditVO: ServiceCreditVO,
        ...
        override fun call(): SignedTransaction {
            ...
            val serviceCreditState = CreateServiceCreditState(serviceCreditVO, authorizerCognizant, listOf(tacticalCustomer, intiatorCognizant,strategicCognizant,strategicCustomer));
            serviceCreditVO.serviceCreditId = serviceCreditState.linearId.id
            val txCommand = Command(ServiceCreditContract.Commands.Update(), serviceCreditState.participants.map { it.owningKey })
            ...
            // Stage 4.
            val tacticalcustomer = initiateFlow(tacticalCustomer)
            ...
            val fullySignedTx = subFlow(CollectSignaturesFlow(partSignedTx, setOf(tacticalcustomer, intiatorcognizant,strategiccognizant,strategiccustomer), GATHERING_SIGS.childProgressTracker()))
